...
<head>
   ...
   #doc2{border:1em solid #fff;background:#fff; color:#000;font-family:calibri,helvetica,sans-serif;-moz-border-radius:5px;-webkit-border-radius:5px;margin-top: 5px}
   h1{font-size:240%;font-weight:bold;padding:.2em 0;}
...
<div id="doc2" class="yui-t7">
   <div id="hd" role="banner"><h1>Christian Heilmann On The Web PHP</h1></div>
   <div id="bd" role="main">
	<div class="yui-g">
